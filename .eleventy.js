...
module.exports = function (eleventyConfig) {
    ...
    // Converts dates from JSDate format (Fri Dec 02 18:00:00 GMT-0600) to a 'd. L. yyyy' format
    eleventyConfig.addFilter("postDate", filterPostDate);
    // END FILTERS

    // SHORTCODES - Add Nunjucks shortcodes to use in templates
    // add {% year %} shortcode for printing the current year - useful for copyright dates
